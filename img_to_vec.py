...
class Img2Vec():
    ...
    #def __init__(self, cuda=False, model='resnet34', layer='default', layer_output_size=512, gpu=0):
    #def __init__(self, cuda=False, model='efficientnet_b1', layer='default', layer_output_size=1280, gpu=0):
    def __init__(self, cuda=True, model='efficientnet_b1', layer='default', layer_output_size=512, gpu=0):
        """ Img2Vec
